class ItemOrder
  ...
  with_options presence: true do
    ...
    validates :postal_code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message:  "はハイフンを入れた7桁で入力してください" }
    validates :city
    validates :block_number
    validates :phone_number, format: { with: /\A[0-9]{11}\z/, message: "はハイフンを除いた11桁で入力してください" }
  end
